...
export interface Deliverable { id: number; project_id: number; domain_code: string; domain_name: string; title: string; description: string; status: 'pending' | 'generated' | 'uploaded'; content: string | null; file_path: string | null; current_version: number; }
export interface DeliverableVersion { id: number; deliverable_id: number; version_number: number; content: string; file_path: string | null; generated_by: string; notes: string | null; created_at: string; }
